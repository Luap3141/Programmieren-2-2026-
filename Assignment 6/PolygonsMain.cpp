...
int main() {
   ...
   //These are the same tests from my Assignment 3
   ...
   Picture<> test;
   for (int i = 0; i < 32; i++) {
      RegularPolygon<>* a = new RegularPolygon<>(0, 5 * i, 200, 7, i, 8 * i * 0x010000);
      test.add(*a);
   }
   ...
   Picture<> test1;
   for (int i = 0; i < 10; i++) {
      Square<>* a = new Square<>(400, 400, 50 * i, i, 0x000000);
      Hexagon<>* b = new Hexagon<>(400, 400, 50 * i, i, 0xFFBBBB);
      test1.add(*a);
      test1.add(*b);
   }
